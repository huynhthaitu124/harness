...
```
Files are written to: `.harness/handoffs/`
...
Configured in: `.harness/mcp.json`

```
HARNESS_STATE_PATH    → .harness/state.json
HARNESS_ARTIFACTS_DIR → .harness/
```

## Project-Specific Reference

> **Read `HARNESS.html` before starting any work on this project.**
> It contains the full architecture overview, key modules, conventions, build workflow,
> and open questions generated by agent deep research.
> This Markdown file only covers the harness routing policy — the HTML has the content.
